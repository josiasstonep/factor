...
_SECTION_GUIDANCE: dict[str, str] = {
    ...
    "analise": (
        ...
        "os fatos divergem.\n"
        "ESCOPO: descreva APENAS o que ocorreu durante o exame neste caso. "
        "NÃO mencione procedimentos não realizados. NÃO descreva resultados positivos se não houve.\n"
        "CASO DE IMPEDIMENTO FÍSICO (conector quebrado, sem energia, tela inoperante):\n"
        "  - Escreva 1 parágrafo descrevendo: (a) condição do dispositivo ao receber; "
        "(b) o impedimento constatado; (c) o que foi impossibilitado em consequência.\n"
        "  - NÃO mencione bloqueio de tela, brute-force, Cellebrite ou extração — se nada disso ocorreu.\n"
        "  - NÃO inclua desfecho (devolução, nova requisição) — isso pertence à Conclusão.\n"
        "VARIÁVEIS: ao mencionar o aparelho, use '(VESTÍGIO {{vestigio}})'. "
        "Preserve TODAS as {{chave}} do original."
    ),
    "conclusao": (
